...
<body>
  ...
  <h4 class="card-title h3 my-1"><strong><i class="fas fa-envelope pr-2"></i>Contate-nos</strong></h4>
  <form class="form-contact" tabindex="1" action="contato.php" method="post"> 
     ...
     <input type="text" class="form-contact-input" name="assunto" placeholder="Assunto" />
